...
const recAmmount = dogs.some(dog => dog.curFood === dog.recFood);
console.log(recAmmount);
...
const shallowCopyForArray = [...dogs]; // SHALLOW COPY ZA ARRAY JE SRPEAD OPERATOR!!!
